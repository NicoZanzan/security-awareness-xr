class ARExperience {
  ...
  resetScene() {
    ...
    // Clean up hand tracking resources if they exist
    if (this.handTracking && this.handTracking.enabled) {
        if (this.handTracking.leftHand) {
            this.scene.remove(this.handTracking.leftHand);
            this.disposeObject(this.handTracking.leftHand);
        }
        if (this.handTracking.rightHand) {
            this.scene.remove(this.handTracking.rightHand);
            this.disposeObject(this.handTracking.rightHand);
        }
    }
