...
ARExperience.prototype.scene3 = function() {
    ...
    // ✅ SKIP moveModel completely - position directly like buttons do
    setTimeout(() => {
        // Position models directly like the working button
        this.laptopModel.position.set(6.06, 0, -3.5);
        this.laptopModel.visible = true;
        this.scene.add(this.laptopModel); // Ensure it's in scene
        
        this.tabletModel.position.set(6.06, 0, 3.5);
        this.tabletModel.visible = true;
        this.scene.add(this.tabletModel);
        
        this.notebookModel.position.set(-6.06, 0, -3.5);
        this.notebookModel.visible = true;
        this.scene.add(this.notebookModel);
        
        // Register interactions immediately like the working button
        this.makeModelClickable(this.laptopModel, () => {
            console.log('💻 Laptop clicked!');
            this.playAudio('audioCorrectAnswer'); 
            this.showNextButton('scene4');       
        ...
        console.log('✅ Models positioned and interactions registered like buttons');
